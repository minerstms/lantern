...
assert(/lantern-cards\.css\?v=20260812-cardoverlay7/.test(explore), '31. Explore CSS cache-bust');
assert(/lantern-cards\.css\?v=20260812-cardoverlay7/.test(contribute), '32. Create CSS cache-bust');
assert(/lantern-cards\.css\?v=20260812-cardoverlay7/.test(locker), '33. My Lantern CSS cache-bust');
