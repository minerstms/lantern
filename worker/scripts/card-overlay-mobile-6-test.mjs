...
assert(/lantern-cards\.css\?v=/.test(explore), '18. Explore cache-busts card CSS');
assert(/lantern-cards\.css\?v=/.test(contribute), '19. Create cache-busts card CSS');
assert(/lantern-cards\.css\?v=/.test(locker), '20. My Lantern cache-busts card CSS');
