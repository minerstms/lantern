...
const expectedIds = ['avatar-match', 'clickrush', 'handbook-trivia', 'lantern-live-trivia', 'local-history-trivia', 'memory', 'nuggetHunt', 'reaction', 'seven-habits-trivia', 'srp-safety-trivia'];
