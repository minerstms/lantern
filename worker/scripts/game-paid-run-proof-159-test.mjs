...
const expectedIds = ['avatar-match', 'clickrush', 'handbook-trivia', 'lantern-live-trivia', 'local-history-trivia', 'memory', 'nuggetHunt', 'orbit-lock', 'reaction', 'srp-safety-trivia'];
