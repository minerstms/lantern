...
const expectedIds = ['avatar-match', 'clickrush', 'handbook-trivia', 'lantern-live-trivia', 'local-history-trivia', 'memory', 'nuggetHunt', 'reaction'];
if (catalogIds.join() === expectedIds.sort().join()) ok('33. all eight catalog games remain the production set');
