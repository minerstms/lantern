...
const srpGameArt = path.join(root, 'app/assets/srp-safety-trivia-card.webp');
if (
...
if (catalogSrc.includes("image: 'assets/srp-safety-trivia-card.webp'") && fs.existsSync(srpGameArt)) {
  ok('game-card artwork unchanged (srp-safety-trivia-card.webp)');
} else bad('game-card artwork');
if (cardsSrc.includes("perm_handbook_trivia: 'assets/handbook-triva-card.webp'") && cardsSrc.includes("perm_local_history_trivia: 'assets/history-trivia-card.webp'")) {
