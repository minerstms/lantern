...
export const LOCAL_HISTORY_TRIVIA_BANK = [
  {
    ...
    "question": "Trinidad, Colorado is in which county?",
    "options": [
      "Pueblo County",
      "Las Animas County",
      "El Paso County",
    ...
    "correctIndex": 1,
    "explanation": "Trinidad is the county seat of Las Animas County."
  },
  {
    "id": "lh2",
    "category": "local_history",
    "question": "What river runs near Trinidad?",
    "options": [
      "Arkansas River",
      "Rio Grande",
      "Purgatoire River",
    ...
    "correctIndex": 2,
    "explanation": "The Purgatoire River flows through the Trinidad area."
  },
  {
    "id": "lh3",
    "category": "local_history",
    "question": "Why is community pride important at school?",
    "options": [
      "It doesn't matter",
      "It helps us care for our place and each other",
      "Only for adults",
      "Only on special days"
    ],
    "correctIndex": 1,
    "explanation": "Caring for our community and each other makes school and town better for everyone."
  },
  {
    "id": "lh4",
    "category": "local_history",
    "question": "What can we do to show school pride?",
    "options": [
      "Ignore school events",
      "Participate, be respectful, and support others",
      "Only show up for games",
      "Complain about everything"
    ],
    "correctIndex": 1,
    "explanation": "Participating and supporting others shows pride in our school."
  },
  {
    "id": "lh5",
    "category": "local_history",
    "question": "Our school is part of our community. That means:",
    "options": [
      "We have nothing to do with the town",
      "We can help make our community stronger",
      "Only teachers matter",
      "Community doesn't affect us"
    ],
    "correctIndex": 1,
    "explanation": "Students and schools can help make the community stronger together."
  },
  {
    "id": "lh6",
    "category": "local_history",
    "question": "Which is a way to learn about local history?",
    "options": [
      "Only from the internet",
      "Visiting local museums, reading, and asking elders",
      "Ignoring it",
      "Only in class"
    ],
    "correctIndex": 1,
    "explanation": "Museums, books, and talking to people who know the area teach us local history."
  },
  {
    "id": "lh7",
    "category": "local_history",
    "question": "Being a good community member includes:",
    "options": [
      "Only looking out for yourself",
      "Helping others and following shared rules",
      "Staying home only",
      "Ignoring neighbors"
    ],
    "correctIndex": 1,
    "explanation": "Helping others and following shared rules makes our community better."
  },
  {
    "id": "lh8",
    "category": "local_history",
    "question": "Why do schools teach about local history?",
    "options": [
      "To fill time",
      "So we understand and value where we live",
      "Only for tests",
      "They don't"
    ],
    "correctIndex": 1,
    "explanation": "Understanding where we live helps us value and care for our community."
  },
  {
    "id": "lh9",
    "category": "local_history",
    "question": "What makes a school a good place to learn?",
    "options": [
      "Only the building",
      "Safe, respectful students and staff working together",
      "No rules",
      "Only grades"
    ],
    "correctIndex": 1,
    "explanation": "When everyone works together with respect, school is a better place to learn."
  },
  {
    "id": "lh10",
    "category": "local_history",
    "question": "How can you contribute to your school community?",
    "options": [
      "By doing nothing",
      "By joining activities, helping others, and being respectful",
      "Only by winning",
      "Only online"
    ],
    "correctIndex": 1,
    "explanation": "Joining in, helping others, and being respectful are ways to contribute."
  }
];
