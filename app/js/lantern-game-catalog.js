  ...
  var GAMES = [
    {
      ...
      play_cost: 1,
      icon: '👤',
      image: 'assets/avatar-match-card.webp',
      featured: true,
      status: 'playable',
    ...
    },
    {
      ...
      play_cost: 1,
      icon: '🏮',
      image: 'assets/lantern-trivia-card.webp',
      featured: true,
      status: 'playable',
      scoring: { lowerIsBetter: false },
      leaderboard: true,
    ...
    },
    {
      ...
      play_cost: 1,
      icon: '📖',
      /* Prompt #87 — source asset on disk is named "handbook-triva-card" (missing the
         "i" in "trivia"); using the exact existing basename rather than renaming the shipped
         artwork file. Prompt #177 re-encoded the same art as WebP. */
      image: 'assets/handbook-triva-card.webp',
      featured: false,
      status: 'playable',
      scoring: { lowerIsBetter: false },
      leaderboard: true,
    ...
    },
    {
      ...
      play_cost: 1,
      icon: '🏛️',
      image: 'assets/history-trivia-card.webp',
      featured: false,
      status: 'playable',
      scoring: { lowerIsBetter: false },
      leaderboard: true,
    ...
    },
    {
      ...
      play_cost: 1,
      icon: '🛡️',
      image: 'assets/srp-safety-trivia-card.webp',
      featured: false,
      status: 'playable',
      scoring: { lowerIsBetter: false },
      leaderboard: true,
    ...
    },
    {
      ...
      play_cost: 1,
      icon: '⚡',
      image: 'assets/reaction-tap-card.webp',
      featured: true,
      status: 'playable',
    ...
    },
    {
      ...
      play_cost: 1,
      icon: '🖱️',
      image: 'assets/nugget-click-rush-card.webp',
      featured: false,
      status: 'playable',
      scoring: { lowerIsBetter: false },
      leaderboard: true,
    ...
    },
    {
      ...
      play_cost: 1,
      icon: '🧠',
      image: 'assets/memory-match-card.webp',
      featured: false,
      status: 'playable',
      scoring: { lowerIsBetter: true },
      leaderboard: true,
    ...
    },
    {
      ...
      play_cost: 1,
      icon: '🔍',
      image: 'assets/nugget-hunt-card.webp',
      featured: false,
      status: 'playable',
      scoring: { lowerIsBetter: true },
      leaderboard: true,
