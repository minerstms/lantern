...
(function (global) {
  ...
  var DISPLAY_LEADERBOARD_GAMES = ['Avatar Match', 'Lantern Live Trivia', 'Handbook Trivia', 'Local History Trivia', 'Reaction Tap', 'Nugget Click Rush', 'Memory Match', 'Nugget Hunt', 'Lantern Stack'];
